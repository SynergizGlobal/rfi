...
public interface RFIService {
    ...
    List<String> getWorkShortNamesByProjectId(String projectId);
	...
	List<String> getComponentByStructureStructureTypeContractId(String structureType,String contractId,String structure);
	List<String> getElementByStructureStructureTypeComponent(String structureType,String structure,String component);
	List<String> getActivityNamesByStructureStructureTypeComponentComponentId(String structureType,String structure,String component,String component_id);
